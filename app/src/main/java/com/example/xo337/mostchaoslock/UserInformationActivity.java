...
import com.example.xo337.mostchaoslock.userInformation.UserInformationGetOnFirebase;
...
public class UserInformationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!TextUtils.isEmpty(data.getStringExtra("firebaseUid"))){//.length()>0) {
            setData = new UserInformationGetOnFirebase(data.getStringExtra("firebaseUid"), show_Name, show_Email, show_Phone);
            ...
            if (tryGetUid.isEmpty()) {
                ...
                setData = new UserInformationGetOnFirebase(tryGetUid, show_Name, show_Email, show_Phone);
                setData.addListenter();
            }
        }
    }
